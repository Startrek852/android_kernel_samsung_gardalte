...
#define UNIVERSAL222AP_DEFAULT_SYNC_CLK	11289600
...
static void universal222ap_micdet(u16 status, void *data)
{
...
static int universal222ap_ext_submicbias(struct snd_soc_dapm_widget *w,
...
const struct snd_soc_dapm_widget universal222ap_dapm_widgets[] = {
	...
	SND_SOC_DAPM_MIC("Sub Mic", universal222ap_ext_submicbias),
...
static void universal222ap_jackdet_set_mode(struct snd_soc_codec *codec,
		u16 mode)
{
	struct wm8994_priv *wm8994 = snd_soc_codec_get_drvdata(codec);
