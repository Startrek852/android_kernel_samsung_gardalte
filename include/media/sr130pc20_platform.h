...
enum sr130pc20_hw_power {
        SR130PC20_HW_POWER_OFF,
        SR130PC20_HW_POWER_ON,
};
...
//	int (*stby_on)(bool);
	...
	int     gpio_rst;
        ...
        int power;
        struct clk *mclk;
        int (*put_power)(struct sr130pc20_platform_data *pdata);
        int (*get_power)(struct sr130pc20_platform_data *pdata);
        int (*power_on)(struct sr130pc20_platform_data *pdata);
        int (*power_off)(struct sr130pc20_platform_data *pdata);
