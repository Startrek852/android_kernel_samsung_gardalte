...
#define CFG_INPUT_CURRENT_MASK				0xF0
#define CFG_INPUT_CURRENT_SHIFT				4
#define CFG_BATT_PRESENT_MASK					0x33

#define CFG_TERMINATION_CURRENT_MASK			0x07
#define CFG_TERMINATION_CURRENT_SHIFT			0

#define CFG_BATT_PRESENT_ENABLE		0x33
#define CFG_AICL_ENABLE					BIT(4)
#define CFG_OTG_ENABLE					BIT(4)
#define CFG_AUTO_RECHARGE_DISABLE			BIT(7)
#define CFG_CURRNT_TERMNATION				BIT(6)
#define CFG_APSD_ENABLE					BIT(2)
#define CMD_A_ALLOW_WRITE				BIT(7)
#define CMD_CHARGE_EN					BIT(1)

#define CFG_ENABLE_IRQ_STATUS			0x12
