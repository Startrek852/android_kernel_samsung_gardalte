...
/* Poll external GPIO before enabling SDIO IRQ */
#define DW_MMC_QUIRK_SDIO_IRQ_EXT_GPIO_POLL	BIT(8)
...
struct dw_mci_board {
	...
	/**
	 * external gpio connected to SDIO IRQ. This will be polled
	 * before enabling SDIO IRQ and IRQ is triggered directly if
	 * low. This avoids overhead of triggering an IRQ in this case.
	 * This is enabled via DW_MMC_QUIRK_SDIO_IRQ_EXT_GPIO_POLL.
	 */
	int ext_irq_gpio;
