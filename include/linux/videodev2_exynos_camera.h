...
#define V4L2_CID_CAMERA_VT_MODE		(V4L2_CID_CAMERA_CLASS_BASE + 150 + 48)
...
#define V4L2_CID_CAMERA_FLASH_MODE		(V4L2_CID_CAMERA_CLASS_BASE+71)
...
#define V4L2_CID_CAMERA_ANTI_SHAKE		(V4L2_CID_CAMERA_CLASS_BASE+81)
...
#define V4L2_CID_CAMERA_TOUCH_AF_START_STOP	(V4L2_CID_CAMERA_CLASS_BASE+82)
enum v4l2_touch_af {
	TOUCH_AF_STOP = 0,
	TOUCH_AF_START,
	TOUCH_AF_MAX,
...
#define V4L2_CID_CAMERA_FRAME_RATE		(V4L2_CID_CAMERA_CLASS_BASE+104)
...
#define V4L2_CID_CAMERA_ANTI_BANDING		(V4L2_CID_CAMERA_CLASS_BASE+105)
...
#define V4L2_CID_CAMERA_RESET			(V4L2_CID_CAMERA_CLASS_BASE+111)
...
#define V4L2_CID_CAMERA_SENSOR_MODE		(V4L2_CID_CAMERA_CLASS_BASE+116)
...
#define V4L2_CID_CAMERA_EXIF_EXPTIME		(V4L2_CID_CAMERA_CLASS_BASE+117)
#define V4L2_CID_CAMERA_EXIF_FLASH		(V4L2_CID_CAMERA_CLASS_BASE+118)
#define V4L2_CID_CAMERA_EXIF_ISO		(V4L2_CID_CAMERA_CLASS_BASE+119)
#define V4L2_CID_CAMERA_EXIF_TV			(V4L2_CID_CAMERA_CLASS_BASE+120)
#define V4L2_CID_CAMERA_EXIF_BV			(V4L2_CID_PRIVATE_BASE+121)
#define V4L2_CID_CAMERA_EXIF_EBV		(V4L2_CID_PRIVATE_BASE+122)
#define V4L2_CID_CAMERA_CHECK_ESD		(V4L2_CID_CAMERA_CLASS_BASE+123)
 ...
 */
#define V4L2_CID_CAMERA_AE_LOCK_UNLOCK	(V4L2_CID_CAMERA_CLASS_BASE + 133)
...
#define V4L2_CID_CAMERA_AWB_LOCK_UNLOCK	(V4L2_CID_CAMERA_CLASS_BASE + 134)
