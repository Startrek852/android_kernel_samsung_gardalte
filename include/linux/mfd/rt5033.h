...
/*    const rt5033_fled_platform_data_t *fled_platform_data;*/
	int irq_gpio;
	int irq_base;
...
extern int rt5033_reg_write(struct i2c_client *i2c, int reg_addr,
			unsigned char data);
extern int rt5033_assign_bits(struct i2c_client *i2c, int reg_addr,
			unsigned char mask, unsigned char data);
extern int rt5033_set_bits(struct i2c_client *i2c, int reg_addr,
			unsigned char mask);
extern int rt5033_clr_bits(struct i2c_client *i2c, int reg_addr,
			unsigned char mask);
