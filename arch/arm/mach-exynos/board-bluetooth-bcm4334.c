...
#if defined(CONFIG_LCD_MIPI_NT35596)
#define GPIO_BT_EN		EXYNOS4_GPC0(3)
#else
#define GPIO_BT_EN		EXYNOS4_GPM2(4)
#endif
#define GPIO_BT_WAKE		EXYNOS4_GPM1(6)
#define GPIO_BT_HOST_WAKE	EXYNOS4_GPX2(0)
