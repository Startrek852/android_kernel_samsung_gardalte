...
static void __init map_noncached_sched_log_buf(void)
{
...
#endif	/* CONFIG_SEC_DEBUG_SCHED_LOG_NONCACHED */
...
static void __init map_noncached_aux_log_buf(void)
{
...
EXPORT_SYMBOL(sec_debug_set_upload_magic);
