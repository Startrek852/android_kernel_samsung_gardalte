...
static void exynos4_pm_rewrite_eint_pending(void)
{
	...
	__raw_writel((__raw_readl(EXYNOS_ARM_CORE_OPTION(0)) & EXYNOS3470_AUDOMATIC_WAKEUP_MASK), EXYNOS_ARM_CORE_OPTION(0));
	__raw_writel((__raw_readl(EXYNOS_ARM_CORE_OPTION(1)) & EXYNOS3470_AUDOMATIC_WAKEUP_MASK), EXYNOS_ARM_CORE_OPTION(1));
	__raw_writel((__raw_readl(EXYNOS_ARM_CORE_OPTION(2)) & EXYNOS3470_AUDOMATIC_WAKEUP_MASK), EXYNOS_ARM_CORE_OPTION(2));
	__raw_writel((__raw_readl(EXYNOS_ARM_CORE_OPTION(3)) & EXYNOS3470_AUDOMATIC_WAKEUP_MASK), EXYNOS_ARM_CORE_OPTION(3));
}
