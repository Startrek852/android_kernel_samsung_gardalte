...
#define EXYNOS_DMC_CLKREG(x)			(S5P_VA_CMU_DMC + (x))
#define EXYNOS_ACP_CLKREG(x)			(S5P_VA_CMU_ACP + (x))
...
#define EXYNOS4_PWR_CTRL			EXYNOS_CLKREG(0x15020)
...
/* Only for EXYNOS4270 */
#define EXYNOS4270_CLKGATE_BUS_LEFTBUS		EXYNOS_CLKREG(0x4700)
#define EXYNOS4270_CLKGATE_BUS_IMAGE		EXYNOS_CLKREG(0x4730)
#define EXYNOS4270_CLKGATE_IP_IMAGE		EXYNOS_CLKREG(0x4930)
#define EXYNOS4270_CLKGATE_BUS_RIGHTBUS		EXYNOS_CLKREG(0x8700)
#define EXYNOS4270_CLKGATE_BUS_PERIR		EXYNOS_CLKREG(0x8760)
#define EXYNOS4270_CLKGATE_IP_PERIR		EXYNOS_CLKREG(0x8960)
#define EXYNOS4270_CLKMUX_STAT_G3D0		EXYNOS_CLKREG(0xC42C)
#define EXYNOS4270_CLKGATE_BUS_CAM0		EXYNOS_CLKREG(0xC720)
#define EXYNOS4270_CLKGATE_BUS_TV		EXYNOS_CLKREG(0xC724)
#define EXYNOS4270_CLKGATE_BUS_MFC		EXYNOS_CLKREG(0xC728)
#define EXYHOS4270_CLKGATE_BUS_G3D		EXYNOS_CLKREG(0xC72C)
#define EXYNOS4270_CLKGATE_BUS_LCD		EXYNOS_CLKREG(0xC734)
#define EXYNOS4270_CLKGATE_BUS_CAM1		EXYNOS_CLKREG(0xC738)
#define EXYNOS4270_CLKGATE_BUS_FSYS0		EXYNOS_CLKREG(0xC740)
#define EXYNOS4270_CLKGATE_BUS_FSYS1		EXYNOS_CLKREG(0xC744)
#define EXYNOS4270_CLKGATE_BUS_PERIL		EXYNOS_CLKREG(0xC750)
#define EXYNOS4270_CLKGATE_SCLK_TV		EXYNOS_CLKREG(0xC824)
#define EXYNOS4270_CLKGATE_SCLK_MFC		EXYNOS_CLKREG(0xC828)
#define EXYNOS4270_CLKGATE_SCLK_G3D		EXYNOS_CLKREG(0xC82C)
#define EXYNOS4270_CLKGATE_SCLK_LCD		EXYNOS_CLKREG(0xC834)
#define EXYNOS4270_CLKGATE_SCLK_ISP		EXYNOS_CLKREG(0xC838)
#define EXYNOS4270_CLKGATE_SCLK_MAUDIO		EXYNOS_CLKREG(0xC83C)
#define EXYNOS4270_CLKGATE_SCLK_FSYS		EXYNOS_CLKREG(0xC840)
#define EXYNOS4270_CLKGATE_SCLK_PERIL		EXYNOS_CLKREG(0xC850
/* EXYNOS4270 DMC BLOCK */
#define EXYNOS4270_CLKSRC_ACP			EXYNOS_ACP_CLKREG(0x00300)
#define EXYNOS4270_MPLL_LOCK			EXYNOS_DMC_CLKREG(0x00008)
#define EXYNOS4270_MPLL_CON0			EXYNOS_DMC_CLKREG(0x00108)
#define EXYNOS4270_MPLL_CON1			EXYNOS_DMC_CLKREG(0x0010C)
#define EXYNOS4270_MPLL_CON2			EXYNOS_DMC_CLKREG(0x00110)
#define EXYNOS4270_BPLL_LOCK			EXYNOS_DMC_CLKREG(0x00118)
#define EXYNOS4270_BPLL_CON0			EXYNOS_DMC_CLKREG(0x00218)
#define EXYNOS4270_BPLL_CON1			EXYNOS_DMC_CLKREG(0x0021C)
#define EXYNOS4270_BPLL_CON2			EXYNOS_DMC_CLKREG(0x00220)
#define EXYNOS4270_CLKSRC_DMC			EXYNOS_DMC_CLKREG(0x00300)
#define EXYNOS4270_CLKDIV_DMC1			EXYNOS_DMC_CLKREG(0x00504)
#define EXYNOS4270_CLKDIV_DMC1_STAT		EXYNOS_DMC_CLKREG(0x00600)
#define EXYNOS4270_CLKGATE_BUS_DMC0		EXYNOS_DMC_CLKREG(0x00700)
#define EXYNOS4270_CLKGATE_BUS_DMC1		EXYNOS_DMC_CLKREG(0x00704)
#define EXYNOS4270_CLKGATE_SCLK_DMC		EXYNOS_DMC_CLKREG(0x00800)
#define EXYNOS4270_CLKGATE_IP_DMC0		EXYNOS_DMC_CLKREG(0x00900)
#define EXYNOS4270_CLKGATE_IP_DMC1		EXYNOS_DMC_CLKREG(0x00904)
#define EXYNOS4270_CLKOUT_CMU_DMC		EXYNOS_DMC_CLKREG(0x00A00)

#define EXYNOS4270_CLKDIV_DMC1_DMC_SHIFT	(27)
#define EXYNOS4270_CLKDIV_DMC1_DMC_MASK		(0x7 << EXYNOS4270_CLKDIV_DMC1_DMC_SHIFT)
#define EXYNOS4270_CLKDIV_DMC1_DMCP_SHIFT	(15)
#define EXYNOS4270_CLKDIV_DMC1_DMCP_MASK	(0x7 << EXYNOS4270_CLKDIV_DMC1_DMCP_SHIFT)
#define EXYNOS4270_CLKDIV_DMC1_DMCD_SHIFT	(11)
#define EXYNOS4270_CLKDIV_DMC1_DMCD_MASK	(0x7 << EXYNOS4270_CLKDIV_DMC1_DMCD_SHIFT)

#define EXYNOS4270_CLKDIV_STAT_DMC_SHIFT	(4)
#define EXYNOS4270_CLKDIV_STAT_DMC_MASK		(0x1 << EXYNOS4270_CLKDIV_STAT_DMC_SHIFT)
#define EXYNOS4270_CLKDIV_STAT_DMCD_SHIFT	(8)
#define EXYNOS4270_CLKDIV_STAT_DMCD_MASK	(0x1 << EXYNOS4270_CLKDIV_STAT_DMCD_SHIFT)
#define EXYNOS4270_CLKDIV_STAT_DMCP_SHIFT	(12)
#define EXYNOS4270_CLKDIV_STAT_DMCP_MASK	(0x1 << EXYNOS4270_CLKDIV_STAT_DMCP_SHIFT)

#define EXYNOS4270_CLKDIV_GPL_SHIFT		(4)
#define EXYNOS4270_CLKDIV_GPL_MASK		(0x7 << EXYNOS4270_CLKDIV_GPL_SHIFT)
#define EXYNOS4270_CLKDIV_GDL_SHIFT		(0)
#define EXYNOS4270_CLKDIV_GDL_MASK		(0x7 << EXYNOS4270_CLKDIV_GDL_SHIFT)

#define EXYNOS4270_CLKDIV_STAT_GPL_SHIFT	(4)
#define EXYNOS4270_CLKDIV_STAT_GPL_MASK		(0x1 << EXYNOS4270_CLKDIV_STAT_GPL_SHIFT)
#define EXYNOS4270_CLKDIV_STAT_GDL_SHIFT	(0)
#define EXYNOS4270_CLKDIV_STAT_GDL_MASK		(0x1 << EXYNOS4270_CLKDIV_STAT_GDL_SHIFT)

#define EXYNOS4270_CLKDIV_GPR_SHIFT		(4)
#define EXYNOS4270_CLKDIV_GPR_MASK		(0x7 << EXYNOS4270_CLKDIV_GPR_SHIFT)
#define EXYNOS4270_CLKDIV_GDR_SHIFT		(0)
#define EXYNOS4270_CLKDIV_GDR_MASK		(0x7 << EXYNOS4270_CLKDIV_GDR_SHIFT)

#define EXYNOS4270_CLKDIV_STAT_GPR_SHIFT	(4)
#define EXYNOS4270_CLKDIV_STAT_GPR_MASK		(0x1 << EXYNOS4270_CLKDIV_STAT_GPR_SHIFT)
#define EXYNOS4270_CLKDIV_STAT_GDR_SHIFT	(0)
#define EXYNOS4270_CLKDIV_STAT_GDR_MASK		(0x1 << EXYNOS4270_CLKDIV_STAT_GDR_SHIFT)

#define EXYNOS4270_CLKDIV_ACLK266_SHIFT		(0)
#define EXYNOS4270_CLKDIV_ACLK266_MASK		(0x7 << EXYNOS4270_CLKDIV_ACLK266_SHIFT)
#define EXYNOS4270_CLKDIV_ACLK100_SHIFT		(4)
#define EXYNOS4270_CLKDIV_ACLK100_MASK		(0xF << EXYNOS4270_CLKDIV_ACLK100_SHIFT)
#define EXYNOS4270_CLKDIV_ACLK160_SHIFT		(8)
#define EXYNOS4270_CLKDIV_ACLK160_MASK		(0x7 << EXYNOS4270_CLKDIV_ACLK160_SHIFT)
#define EXYNOS4270_CLKDIV_ACLK200_SHIFT		(12)
#define EXYNOS4270_CLKDIV_ACLK200_MASK		(0x7 << EXYNOS4270_CLKDIV_ACLK200_SHIFT)
#define EXYNOS4270_CLKDIV_ACLK400_SHIFT		(24)
#define EXYNOS4270_CLKDIV_ACLK400_MASK		(0x7 << EXYNOS4270_CLKDIV_ACLK400_SHIFT)

#define EXYNOS4270_CLKDIV_STAT_ACLK266_SHIFT	(0)
#define EXYNOS4270_CLKDIV_STAT_ACLK266_MASK	(0x1 << EXYNOS4270_CLKDIV_ACLK266_SHIFT)
#define EXYNOS4270_CLKDIV_STAT_ACLK100_SHIFT	(4)
#define EXYNOS4270_CLKDIV_STAT_ACLK100_MASK	(0x1 << EXYNOS4270_CLKDIV_ACLK100_SHIFT)
#define EXYNOS4270_CLKDIV_STAT_ACLK160_SHIFT	(8)
#define EXYNOS4270_CLKDIV_STAT_ACLK160_MASK	(0x1 << EXYNOS4270_CLKDIV_ACLK160_SHIFT)
#define EXYNOS4270_CLKDIV_STAT_ACLK200_SHIFT	(12)
#define EXYNOS4270_CLKDIV_STAT_ACLK200_MASK	(0x1 << EXYNOS4270_CLKDIV_ACLK200_SHIFT)
#define EXYNOS4270_CLKDIV_STAT_ACLK400_SHIFT	(24)
#define EXYNOS4270_CLKDIV_STAT_ACLK400_MASK	(0x1 << EXYNOS4270_CLKDIV_ACLK400_SHIFT)

#define EXYNOS4270_CLKDIV_MFC_SHIFT		(0)
#define EXYNOS4270_CLKDIV_MFC_MASK		(0xF << EXYNOS4_CLKDIV_MFC_SHIFT)

#define EXYNOS4270_CLKDIV_STAT_MFC_SHIFT	(0)
#define EXYNOS4270_CLKDIV_STAT_MFC_MASK		(0x1 << EXYNOS4270_CLKDIV_STAT_MFC_SHIFT)

#define EXYNOS4270_CLKDIV_CSIS0_SHIFT		(24)
#define EXYNOS4270_CLKDIV_CSIS0_MASK		(0xF << EXYNOS4270_CLKDIV_CSIS0_SHIFT)
#define EXYNOS4270_CLKDIV_CSIS1_SHIFT		(28)
#define EXYNOS4270_CLKDIV_CSIS1_MASK		(0xF << EXYNOS4270_CLKDIV_CSIS1_SHIFT)

#define EXYNOS4270_CLKDIV_STAT_CSIS0_SHIFT	(24)
#define EXYNOS4270_CLKDIV_STAT_CSIS0_MASK	(0x1 << EXYNOS4270_CLKDIV_STAT_CSIS0_SHIFT)
#define EXYNOS4270_CLKDIV_STAT_CSIS1_SHIFT	(28)
#define EXYNOS4270_CLKDIV_STAT_CSIS1_MASK	(0x1 << EXYNOS4270_CLKDIV_STAT_CSIS1_SHIFT)
#define EXYNOS4270_CLKDIV_STAT_FIMC3_SHIFT	(12)
#define EXYNOS4270_CLKDIV_STAT_FIMC3_MASK	(0x1 << EXYNOS4270_CLKDIV_STAT_FIMC3_SHIFT)
#define EXYNOS4270_CLKDIV_STAT_FIMC2_SHIFT	(8)
#define EXYNOS4270_CLKDIV_STAT_FIMC2_MASK	(0x1 << EXYNOS4270_CLKDIV_STAT_FIMC2_SHIFT)
#define EXYNOS4270_CLKDIV_STAT_FIMC1_SHIFT	(4)
#define EXYNOS4270_CLKDIV_STAT_FIMC1_MASK	(0x1 << EXYNOS4270_CLKDIV_STAT_FIMC1_SHIFT)
#define EXYNOS4270_CLKDIV_STAT_FIMC0_SHIFT	(0)
#define EXYNOS4270_CLKDIV_STAT_FIMC0_MASK	(0x1 << EXYNOS4270_CLKDIV_STAT_FIMC0_SHIFT)
/* EXYNOS4270 ACP BLOCK */
#define EXYNOS4270_CLKSRC_ACP			EXYNOS_ACP_CLKREG(0x00300)
#define EXYNOS4270_CLKSRC_MASK_ACP		EXYNOS_ACP_CLKREG(0x00304)
#define EXYNOS4270_CLKDIV_ACP0			EXYNOS_ACP_CLKREG(0x00500)
#define EXYNOS4270_CLKDIV_ACP1			EXYNOS_ACP_CLKREG(0x00504)
#define EXYNOS4270_CLKDIV_STAT_ACP0		EXYNOS_ACP_CLKREG(0x00600)
#define EXYNOS4270_CLKDIV_STAT_ACP1		EXYNOS_ACP_CLKREG(0x00604)
#define EXYNOS4270_CLKGATE_BUS_ACP0		EXYNOS_ACP_CLKREG(0x00700)
#define EXYNOS4270_CLKGATE_BUS_ACP1		EXYNOS_ACP_CLKREG(0x00704)
#define EXYNOS4270_CLKGATE_SCLK_ACP		EXYNOS_ACP_CLKREG(0x00800)
#define EXYNOS4270_CLKGATE_IP_ACP0		EXYNOS_ACP_CLKREG(0x00900)
#define EXYNOS4270_CLKGATE_IP_ACP1		EXYNOS_ACP_CLKREG(0x00904)

#define EXYNOS4270_CLKDIV_ACP_SHIFT		(0)
#define EXYNOS4270_CLKDIV_ACP_MASK		(0x7 << EXYNOS4270_CLKDIV_ACP_SHIFT)
#define EXYNOS4270_CLKDIV_ACP_PCLK_SHIFT	(4)
#define EXYNOS4270_CLKDIV_ACP_PCLK_MASK		(0x7 << EXYNOS4270_CLKDIV_ACP_PCLK_SHIFT)
#define EXYNOS4270_CLKDIV_ACP_DMC_SHIFT		(8)
#define EXYNOS4270_CLKDIV_ACP_DMC_MASK		(0x7 << EXYNOS4270_CLKDIV_ACP_DMC_SHIFT)
#define EXYNOS4270_CLKDIV_ACP_DMCD_SHIFT	(12)
#define EXYNOS4270_CLKDIV_ACP_DMCD_MASK		(0x7 << EXYNOS4270_CLKDIV_ACP_DMCD_SHIFT)
#define EXYNOS4270_CLKDIV_ACP_DMCP_SHIFT	(16)
#define EXYNOS4270_CLKDIV_ACP_DMCP_MASK		(0x7 << EXYNOS4270_CLKDIV_ACP_DMCP_SHIFT)
#define EXYNOS4270_CLKDIV_ACP_DMC_PRE_SHIFT	(20)
#define EXYNOS4270_CLKDIV_ACP_DMC_PRE_MASK	(0x7 << EXYNOS4270_CLKDIV_ACP_DMC_PRE_SHIFT)
#define EXYNOS4270_CLKDIV_ACP_G2D_SHIFT		(0)
#define EXYNOS4270_CLKDIV_ACP_G2D_MASK		(0xF << EXYNOS4270_CLKDIV_ACP_G2D_SHIFT)

#define EXYNOS4270_CLKDIV_STAT_ACP_SHIFT	(0)
#define EXYNOS4270_CLKDIV_STAT_ACP_MASK		(0x1 << EXYNOS4270_CLKDIV_STAT_ACP_SHIFT)
#define EXYNOS4270_CLKDIV_STAT_ACP_PCLK_SHIFT	(4)
#define EXYNOS4270_CLKDIV_STAT_ACP_PCLK_MASK	(0x1 << EXYNOS4270_CLKDIV_STAT_ACP_PCLK_SHIFT)
#define EXYNOS4270_CLKDIV_STAT_ACP_DMC_SHIFT	(8)
#define EXYNOS4270_CLKDIV_STAT_ACP_DMC_MASK	(0x1 << EXYNOS4270_CLKDIV_STAT_ACP_DMC_SHIFT)
#define EXYNOS4270_CLKDIV_STAT_ACP_DMCD_SHIFT	(12)
#define EXYNOS4270_CLKDIV_STAT_ACP_DMCD_MASK	(0x1 << EXYNOS4270_CLKDIV_STAT_ACP_DMCD_SHIFT)
#define EXYNOS4270_CLKDIV_STAT_ACP_DMCP_SHIFT	(16)
#define EXYNOS4270_CLKDIV_STAT_ACP_DMCP_MASK	(0x1 << EXYNOS4270_CLKDIV_STAT_ACP_DMCP_SHIFT)
#define EXYNOS4270_CLKDIV_STAT_ACP_DMCPRE_SHIFT	(20)
#define EXYNOS4270_CLKDIV_STAT_ACP_DMCPRE_MASK	(0x1 << EXYNOS4270_CLKDIV_STAT_ACP_DMCPRE_SHIFT)
#define EXYNOS4270_CLKDIV_STAT_ACP_G2D_SHIFT	(0)
#define EXYNOS4270_CLKDIV_STAT_ACP_G2D_MASK	(0x1 << EXYNOS4270_CLKDIV_STAT_ACP_G2D_SHIFT)
...
#define EXYNOS4_CLKDIV_STAT_ISP0_ISP0_SHIFT	(0)
#define EXYNOS4_CLKDIV_STAT_ISP0_ISP0_MASK	(0x1 << EXYNOS4_CLKDIV_STAT_ISP0_ISP0_SHIFT)
#define EXYNOS4_CLKDIV_STAT_ISP0_ISP1_SHIFT	(4)
#define EXYNOS4_CLKDIV_STAT_ISP0_ISP1_MASK	(0x1 << EXYNOS4_CLKDIV_STAT_ISP0_ISP0_SHIFT)

#define EXYNOS4_CLKDIV_STAT_ISP1_MPWM_SHIFT	(0)
#define EXYNOS4_CLKDIV_STAT_ISP1_MPWM_MASK	(0x1 << EXYNOS4_CLKDIV_STAT_ISP1_MPWM_SHIFT)
#define EXYNOS4_CLKDIV_STAT_ISP1_MCUISP0_SHIFT	(4)
#define EXYNOS4_CLKDIV_STAT_ISP1_MCUISP0_MASK	(0x1 << EXYNOS4_CLKDIV_ISP1_MCUISP0_SHIFT)
#define EXYNOS4_CLKDIV_STAT_ISP1_MCUISP1_SHIFT	(8)
#define EXYNOS4_CLKDIV_STAT_ISP1_MCUISP1_MASK	(0x1 << EXYNOS4_CLKDIV_ISP1_MCUISP1_SHIFT)
...
#define EXYNOS5250_VPLL_LOCK			EXYNOS_CLKREG(0x10040)
#define EXYNOS5_VPLL_LOCK			EXYNOS5250_VPLL_LOCK
