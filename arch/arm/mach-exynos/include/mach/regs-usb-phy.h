...
#define PHY1_HSIC1_FORCE_SUSPEND	(1 << 12)
#define PHY1_HSIC0_SLEEP		(1 << 11)
#define PHY1_HSIC0_ANALOG_POWERDOWN	(1 << 10)
...
#define HOST_LINK_PORT_SWRST_MASK	(0xf << 7)
#define HOST_LINK_PORT1_SWRST		(1 << 9)
#define HOST_LINK_PORT0_SWRST		(1 << 10)
#define HOST_LINK_ALL_SWRST		(1 << 7)

#define PHY1_SWRST_MASK			(0xf << 3)
#define PHY1_HSIC_SWRST			(1 << 6)
