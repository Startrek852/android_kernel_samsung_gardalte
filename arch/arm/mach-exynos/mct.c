...
static int __cpuinit exynos4_local_timer_setup(struct clock_event_device *evt)
{
	...
	if (mct_int_type == MCT_INT_SPI) {
		...
		switch (cpu) {
		case 0:
			mct_lx_irq = (soc_is_exynos4210() || soc_is_exynos4270() || soc_is_exynos3470())
					? EXYNOS4_IRQ_MCT_L0 : EXYNOS5_IRQ_MCT_L0;
			break;
		case 1:
			mct_lx_irq = (soc_is_exynos4210() || soc_is_exynos4270() || soc_is_exynos3470())
					? EXYNOS4_IRQ_MCT_L1 : EXYNOS5_IRQ_MCT_L1;
			break;
		case 2:
			mct_lx_irq = soc_is_exynos3470() ? EXYNOS4_IRQ_MCT_L2 : EXYNOS5_IRQ_MCT_L2;
			break;
		case 3:
			mct_lx_irq = soc_is_exynos3470() ? EXYNOS4_IRQ_MCT_L3 : EXYNOS5_IRQ_MCT_L3;
			break;
		}
