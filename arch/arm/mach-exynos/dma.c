...
static u8 exynos4270_pdma0_peri[] = {
	DMACH_PCM0_RX,
	DMACH_PCM0_TX,
	DMACH_PCM2_RX,
	DMACH_PCM2_TX,
...
static u8 exynos4270_pdma1_peri[] = {
	DMACH_PCM0_RX,
	DMACH_PCM0_TX,
	DMACH_PCM1_RX,
	DMACH_PCM1_TX,
...
static int __init exynos_dma_init(void)
{
	...
	if (soc_is_exynos4210()) {
		...
		exynos_pdma0_pdata.nr_valid_peri =
			ARRAY_SIZE(exynos4270_pdma0_peri);
		exynos_pdma0_pdata.peri_id = exynos4270_pdma0_peri;
		exynos_pdma1_pdata.nr_valid_peri =
			ARRAY_SIZE(exynos4270_pdma1_peri);
		exynos_pdma1_pdata.peri_id = exynos4270_pdma1_peri;
	...
	if (soc_is_exynos4210() || soc_is_exynos4212() || soc_is_exynos4412() || soc_is_exynos4270() || soc_is_exynos3470()) {
