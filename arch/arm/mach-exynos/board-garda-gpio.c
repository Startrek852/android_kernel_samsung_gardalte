...
static struct sec_gpio_init_data shannon222ap_init_table[] = {
	...
	{EXYNOS4_GPK1(6), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
        ...
        {EXYNOS4_GPK2(1), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
...
static unsigned int shannon222ap_sleep_gpio_table_latest[][3] = {
	...
	{EXYNOS4_GPK0(0), S5P_GPIO_PD_PREV_STATE, S5P_GPIO_PD_UPDOWN_DISABLE}, /*NAND_CLK*/
	{EXYNOS4_GPK0(1), S5P_GPIO_PD_PREV_STATE, S5P_GPIO_PD_UPDOWN_DISABLE}, /*NAND_CMD*/
	{EXYNOS4_GPK0(2), S5P_GPIO_PD_PREV_STATE, S5P_GPIO_PD_UPDOWN_DISABLE}, /*MMC_PWR_EN*/
	{EXYNOS4_GPK0(3), S5P_GPIO_PD_PREV_STATE, S5P_GPIO_PD_UPDOWN_DISABLE}, /*NAND_D(0)*/
	{EXYNOS4_GPK0(4), S5P_GPIO_PD_PREV_STATE, S5P_GPIO_PD_UPDOWN_DISABLE}, /*NAND_D(1)*/
	{EXYNOS4_GPK0(5), S5P_GPIO_PD_PREV_STATE, S5P_GPIO_PD_UPDOWN_DISABLE}, /*NAND_D(2)*/
	{EXYNOS4_GPK0(6), S5P_GPIO_PD_PREV_STATE, S5P_GPIO_PD_UPDOWN_DISABLE}, /*NAND_D(3)*/
	{EXYNOS4_GPK0(7), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_UPDOWN_DISABLE}, /*10K PD*/

	{EXYNOS4_GPL0(0), S5P_GPIO_PD_PREV_STATE, S5P_GPIO_PD_UPDOWN_DISABLE}, /*NAND_D(4)*/
	{EXYNOS4_GPL0(1), S5P_GPIO_PD_PREV_STATE, S5P_GPIO_PD_UPDOWN_DISABLE}, /*NAND_D(5)*/
	{EXYNOS4_GPL0(2), S5P_GPIO_PD_PREV_STATE, S5P_GPIO_PD_UPDOWN_DISABLE}, /*NAND_D(6)*/
	{EXYNOS4_GPL0(3), S5P_GPIO_PD_PREV_STATE, S5P_GPIO_PD_UPDOWN_DISABLE}, /*NAND_D(7)*/
