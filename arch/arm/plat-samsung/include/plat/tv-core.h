...
#define is_ip_ver_4p_1 (pdata->ip_ver == IP_VER_TV_4P_1)
#define is_ip_ver_4c_0 (pdata->ip_ver == IP_VER_TV_4C_0)
...
#define is_ip_ver_4p   (is_ip_ver_4p_1)
#define is_ip_ver_4c   (is_ip_ver_4c_0)
#define is_ip_ver_4    (is_ip_ver_4p || is_ip_ver_4c)
#define is_ip_ver_5g   (is_ip_ver_5g_1)
#define is_ip_ver_5a   (is_ip_ver_5a_0 || is_ip_ver_5a_1)
#define is_ip_ver_5    (is_ip_ver_5g || is_ip_ver_5a)
