...
static unsigned int clkdiv_cpu0_3470[CPUFREQ_LEVEL_END][6] = {
	/*
...
static unsigned int clkdiv_cpu1_3470[CPUFREQ_LEVEL_END][2] = {
	/*
	 *Clock divider value for following
	 * { DIVCOPY, DIVHPM }
	 */
...
static unsigned int exynos3470_apll_pms_table[CPUFREQ_LEVEL_END] = {
...
static const unsigned int asv_voltage_3470[CPUFREQ_LEVEL_END] = {
	1250000,
	1200000,
	1150000,
	1100000,
