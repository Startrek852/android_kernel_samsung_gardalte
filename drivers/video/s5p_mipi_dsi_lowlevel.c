...
#ifdef CONFIG_LCD_MIPI_HX8369B
/* for ESD of LCD.
* this code make LP-mode between frame-data and frame-data.
* if you acivate this code, you must change rgb_timing.stable_vfp and .rgb_timing.cmd_allow 
* in board-xxx-display.c
*/
	cfg |= DSIM_CLK_LANE_ENABLE(30);
#endif
