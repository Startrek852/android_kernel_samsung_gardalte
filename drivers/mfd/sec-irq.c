...
static struct sec_irq_data s2mpu01_irqs[] = {
	[S2MPU01_IRQ_PWRONF] = {
		.reg = 1,
		.mask = S2MPU01_IRQ_PWRONF_MASK,
	},
	[S2MPU01_IRQ_PWRONR] = {
		.reg = 1,
		.mask = S2MPU01_IRQ_PWRONR_MASK,
	},
	[S2MPU01_IRQ_JIGONBF] = {
		.reg = 1,
		.mask = S2MPU01_IRQ_JIGONBF_MASK,
	},
	[S2MPU01_IRQ_JIGONBR] = {
		.reg = 1,
		.mask = S2MPU01_IRQ_JIGONBR_MASK,
	},
	[S2MPU01_IRQ_ACOKBF] = {
		.reg = 1,
		.mask = S2MPU01_IRQ_ACOKBF_MASK,
	},
	[S2MPU01_IRQ_ACOKBR] = {
		.reg = 1,
		.mask = S2MPU01_IRQ_ACOKBR_MASK,
	},
	[S2MPU01_IRQ_PWRON1S] = {
		.reg = 1,
		.mask = S2MPU01_IRQ_PWRON1S_MASK,
	},
	[S2MPU01_IRQ_MRB] = {
		.reg = 1,
		.mask = S2MPU01_IRQ_MRB_MASK,
	},
	[S2MPU01_IRQ_RTC60S] = {
		.reg = 2,
		.mask = S2MPU01_IRQ_RTC60S_MASK,
	},
	[S2MPU01_IRQ_RTCA1] = {
		.reg = 2,
		.mask = S2MPU01_IRQ_RTCA1_MASK,
	},
	[S2MPU01_IRQ_RTCA0] = {
		.reg = 2,
		.mask = S2MPU01_IRQ_RTCA0_MASK,
	},
	[S2MPU01_IRQ_SMPL] = {
		.reg = 2,
		.mask = S2MPU01_IRQ_SMPL_MASK,
	},
	[S2MPU01_IRQ_RTC1S] = {
		.reg = 2,
		.mask = S2MPU01_IRQ_RTC1S_MASK,
	},
	[S2MPU01_IRQ_WTSR] = {
		.reg = 2,
		.mask = S2MPU01_IRQ_WTSR_MASK,
	},
	[S2MPU01_IRQ_INT120C] = {
		.reg = 3,
		.mask = S2MPU01_IRQ_INT120C_MASK,
	},
	[S2MPU01_IRQ_INT140C] = {
		.reg = 3,
		.mask = S2MPU01_IRQ_INT140C_MASK,
	},
	[S2MPU01_IRQ_LDO3_TSD] = {
		.reg = 3,
		.mask = S2MPU01_IRQ_LDO3_TSD_MASK,
	},
	[S2MPU01_IRQ_B15_TSD] = {
		.reg = 3,
		.mask = S2MPU01_IRQ_B15_TSD_MASK,
	},
	[S2MPU01_IRQ_B34_TSD] = {
		.reg = 3,
		.mask = S2MPU01_IRQ_B34_TSD_MASK,
	},
	[S2MPU01_IRQ_B2_TSD] = {
		.reg = 3,
		.mask = S2MPU01_IRQ_B2_TSD_MASK,
	},
};

static struct sec_irq_data s2mpu01a_irqs[] = {
	[S2MPU01A_IRQ_PWRONF] = {
		.reg = 1,
		.mask = S2MPU01A_IRQ_PWRONF_MASK,
	},
	[S2MPU01A_IRQ_PWRONR] = {
		.reg = 1,
		.mask = S2MPU01A_IRQ_PWRONR_MASK,
	},
	[S2MPU01A_IRQ_JIGONBF] = {
		.reg = 1,
		.mask = S2MPU01A_IRQ_JIGONBF_MASK,
	},
	[S2MPU01A_IRQ_JIGONBR] = {
		.reg = 1,
		.mask = S2MPU01A_IRQ_JIGONBR_MASK,
	},
	[S2MPU01A_IRQ_ACOKF] = {
		.reg = 1,
		.mask = S2MPU01A_IRQ_ACOKF_MASK,
	},
	[S2MPU01A_IRQ_ACOKR] = {
		.reg = 1,
		.mask = S2MPU01A_IRQ_ACOKR_MASK,
	},
	[S2MPU01A_IRQ_PWRON1S] = {
		.reg = 1,
		.mask = S2MPU01A_IRQ_PWRON1S_MASK,
	},
	[S2MPU01A_IRQ_MRB] = {
		.reg = 1,
		.mask = S2MPU01A_IRQ_MRB_MASK,
	},
	[S2MPU01A_IRQ_RTC60S] = {
		.reg = 2,
		.mask = S2MPU01A_IRQ_RTC60S_MASK,
	},
	[S2MPU01A_IRQ_RTCA1] = {
		.reg = 2,
		.mask = S2MPU01A_IRQ_RTCA1_MASK,
	},
	[S2MPU01A_IRQ_RTCA0] = {
		.reg = 2,
		.mask = S2MPU01A_IRQ_RTCA0_MASK,
	},
	[S2MPU01A_IRQ_SMPL] = {
		.reg = 2,
		.mask = S2MPU01A_IRQ_SMPL_MASK,
	},
	[S2MPU01A_IRQ_RTC1S] = {
		.reg = 2,
		.mask = S2MPU01A_IRQ_RTC1S_MASK,
	},
	[S2MPU01A_IRQ_WTSR] = {
		.reg = 2,
		.mask = S2MPU01A_IRQ_WTSR_MASK,
	},
	[S2MPU01A_IRQ_INT120C] = {
		.reg = 3,
		.mask = S2MPU01A_IRQ_INT120C_MASK,
	},
	[S2MPU01A_IRQ_INT140C] = {
		.reg = 3,
		.mask = S2MPU01A_IRQ_INT140C_MASK,
	},
	[S2MPU01A_IRQ_LDO3_TSD] = {
		.reg = 3,
		.mask = S2MPU01A_IRQ_LDO3_TSD_MASK,
	},
	[S2MPU01A_IRQ_B15_TSD] = {
		.reg = 3,
		.mask = S2MPU01A_IRQ_B15_TSD_MASK,
	},
	[S2MPU01A_IRQ_B34_TSD] = {
		.reg = 3,
		.mask = S2MPU01A_IRQ_B34_TSD_MASK,
	},
	[S2MPU01A_IRQ_B2_TSD] = {
		.reg = 3,
		.mask = S2MPU01A_IRQ_B2_TSD_MASK,
	},
};
...
irq_to_sec_pmic_irq(struct sec_pmic_dev *sec_pmic, int irq)
{
	...
	case S2MPU01X:
		return &s2mpu01_irqs[irq - sec_pmic->irq_base];
	case S2MPU01A:
		return &s2mpu01a_irqs[irq - sec_pmic->irq_base];
	default:
		return NULL;
	}
}
...
static void sec_pmic_irq_sync_unlock(struct irq_data *data)
{
	...
	case S2MPS11X:
		...
		break;
	case S2MPU01X:
		reg_int1m = S2MPU01_REG_INT1M;
		break;
	case S2MPU01A:
		reg_int1m = S2MPU01A_REG_INT1M;
		break;
	default:
...
static irqreturn_t sec_pmic_irq_thread(int irq, void *data)
{
	...
	case S2MPS11X:
		...
		break;
	case S2MPU01X:
		reg_int1 = S2MPU01_REG_INT1;
		break;
	case S2MPU01A:
		reg_int1 = S2MPU01A_REG_INT1;
		break;
	default:
		dev_err(sec_pmic->dev,
			"Unknown device type %d\n",
	...
	switch (sec_pmic->device_type) {
	case S2MPU01X:
		for (i = 0; i < S2MPU01_IRQ_NR; i++) {
			if (irq_reg[s2mpu01_irqs[i].reg - 1] & s2mpu01_irqs[i].mask)
				handle_nested_irq(sec_pmic->irq_base + i);
		}
		break;
	case S2MPU01A:
		for (i = 0; i < S2MPU01A_IRQ_NR; i++) {
			if (irq_reg[s2mpu01a_irqs[i].reg - 1] & s2mpu01a_irqs[i].mask) {
				dev_emerg(sec_pmic->dev, "**** s2mpu01a_irqs list : [%d] 0x%x*****\n", i - 1, irq_reg[s2mpu01a_irqs[i].reg - 1]);
				handle_nested_irq(sec_pmic->irq_base + i);
			}
		}
		break;
...
int sec_irq_init(struct sec_pmic_dev *sec_pmic)
{
	...
	case S2MPU01X:
		reg_int1m = S2MPU01_REG_INT1M;
		reg_irq_nr = S2MPU01_IRQ_NR;
		break;
	case S2MPU01A:
		reg_int1m = S2MPU01A_REG_INT1M;
		reg_irq_nr = S2MPU01A_IRQ_NR;
		break;
	default:
		dev_err(sec_pmic->dev,
			"Unknown device type %d\n",
