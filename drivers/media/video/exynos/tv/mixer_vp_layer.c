...
static void mxr_vp_fix_geometry(struct mxr_layer *layer)
{
	...
	mxr_dbg(mdev, "source device geometry information\n");
	mxr_dbg(mdev, "full width = %d, full height = %d\n",
			geo->src.full_width, geo->src.full_height);
	mxr_dbg(mdev, "width = %d, height = %d, x = %d, y = %d\n",
			geo->src.width, geo->src.height,
			geo->src.x_offset, geo->src.y_offset);
	mxr_dbg(mdev, "sink device geometry information\n");
	mxr_dbg(mdev, "full width = %d, full height = %d\n",
