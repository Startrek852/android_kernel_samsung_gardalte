...
enum sr130pc20_oprmode {
	...
	SR130PC20_OPRMODE_MAX   = 2,
};

struct sr130pc20_resolution {
	u8			value;
...
static struct v4l2_mbus_framefmt default_fmt[SR130PC20_OPRMODE_MAX] = {
	[SR130PC20_OPRMODE_VIDEO] = {
...
/* make look-up table */
static const struct sr130pc20_resolution sr130pc20_resolutions[] = {
	/* monitor size */
	{PREVIEW_SZ_QCIF	, SR130PC20_OPRMODE_VIDEO, 176,  144  },
	{PREVIEW_SZ_320x240	, SR130PC20_OPRMODE_VIDEO, 320,  240  },
	{PREVIEW_SZ_CIF		, SR130PC20_OPRMODE_VIDEO, 352,  288  },
	{PREVIEW_SZ_528x432	, SR130PC20_OPRMODE_VIDEO, 528,  432  },
	{PREVIEW_SZ_640x360	, SR130PC20_OPRMODE_VIDEO, 640,  360  },/*16:9*/
	{PREVIEW_SZ_VGA		, SR130PC20_OPRMODE_VIDEO, 640,  480  },
	{PREVIEW_SZ_D1		, SR130PC20_OPRMODE_VIDEO, 720,  480  },
	{PREVIEW_SZ_880x720	, SR130PC20_OPRMODE_VIDEO, 880,  720  },
	{PREVIEW_SZ_SVGA	, SR130PC20_OPRMODE_VIDEO, 800,  600  },
	{PREVIEW_SZ_1024x576	, SR130PC20_OPRMODE_VIDEO, 1024, 576  },/*16:9*/
	{PREVIEW_SZ_1024x616	, SR130PC20_OPRMODE_VIDEO, 1024, 616  },
	{PREVIEW_SZ_XGA		, SR130PC20_OPRMODE_VIDEO, 1024,  768 },
	{PREVIEW_SZ_PVGA	, SR130PC20_OPRMODE_VIDEO, 1280,  720 },
	{PREVIEW_SZ_SXGA	, SR130PC20_OPRMODE_VIDEO, 1280,  1024},

	/* capture(JPEG or Bayer RAW or YUV Raw) size */
	{CAPTURE_SZ_1MP		, SR130PC20_OPRMODE_IMAGE, 1280, 960  },
	{CAPTURE_SZ_1280x720	, SR130PC20_OPRMODE_IMAGE, 1280, 720  },
};
...
struct sr130pc20_regs {
	struct regset_table ev[GET_EV_INDEX(EV_MAX)];
...
struct sr130pc20_state {
	...
	enum sr130pc20_oprmode		oprmode;
...
static int sr130pc20_s_config(struct v4l2_subdev *sd, int irq, void *platform_data);
