...
#define CFG_OUT_PRESS       (2451)
#define CFG_OUT_9QUAT       (2246)
#define CFG_PED_ENABLE      (2556)
#define CFG_OUT_GYRO        (2383)
#define CFG_PEDSTEP_DET     (2828)
#define OUT_GYRO_DAT        (2392)
#define CFG_FIFO_INT        (2554)
#define OUT_CPASS_DAT       (2426)
#define CFG_AUTH            (1176)
#define OUT_ACCL_DAT        (2358)
#define FCFG_1              (1203)
#define CFG_OUT_PQUAT9      (2315)
#define FCFG_3              (1228)
#define FCFG_2              (1207)
#define CFG_OUT_CPASS       (2417)
#define FCFG_7              (1214)
#define CFG_OUT_3QUAT       (2176)
#define OUT_PRESS_DAT       (2460)
#define OUT_3QUAT_DAT       (2186)
#define CFG_7               (1425)
#define OUT_PQUAT_DAT       (2290)
#define CFG_OUT_6QUAT       (2211)
#define CFG_PED_INT         (2825)
#define SMD_TP2             (1390)
#define SMD_TP1             (1369)
#define CFG_MOTION_BIAS     (1427)
#define CFG_OUT_ACCL        (2349)
#define CFG_OUT_STEPDET     (2146)
#define OUT_9QUAT_DAT       (2256)
#define OUT_6QUAT_DAT       (2221)
#define CFG_OUT_PQUAT       (2281)
