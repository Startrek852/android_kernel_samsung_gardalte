...
static void dpm_resume_noirq(pm_message_t state)
{
	...
	sec_debug_pm_log(raw_smp_processor_id(), "dpm_resume_noirq()", 0);
	mutex_lock(&dpm_list_mtx);
	...
	resume_device_irqs();
	sec_debug_pm_log(raw_smp_processor_id(), "dpm_resume_noirq()", 1);
}
...
static void dpm_resume_early(pm_message_t state)
{
	...
	while (!list_empty(&dpm_late_early_list)) {
		...
		sec_debug_pm_log(raw_smp_processor_id(), dev_name(dev), 0);
		...
		sec_debug_pm_log(raw_smp_processor_id(), dev_name(dev), 1);
